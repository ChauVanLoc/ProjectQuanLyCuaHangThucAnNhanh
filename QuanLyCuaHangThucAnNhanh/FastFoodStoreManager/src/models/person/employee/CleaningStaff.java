...
public class CleaningStaff extends EmployeeObserver {
	public CleaningStaff(String cccd, String name, Date dateOfBirth, Date expiredDate, String sex, Address address, String email,
		...
		super.person.setAccount(new Account(email, Password.DEFAULT, Rule.CLEANING, expiredDate));
